...
"These lines can be re-ordered; they are executed from top to bottom.\n");
	...
	strbuf_add_commented_lines(buf, msg, strlen(msg), repo_get_comment_line_str(the_repository, NULL));
		   ...
		   unsigned flags)
{
	...
	strbuf_stripspace(&new_todo->buf, repo_get_comment_line_str(the_repository, NULL));
